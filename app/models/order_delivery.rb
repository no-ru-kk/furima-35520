class OrderDelivery
  ...
  with_options presence: true do
    ...
    validates :phone_number, numericality: {only_integer: true, greater_than_or_equal_to: 0, less_than_or_equal_to: 99999999999 , message: "is invalid.Only numbers within 11 digits can be saved"}
  end
